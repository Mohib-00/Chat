...
<body>
   ...
   <script>
    document.getElementById('circularCheckbox').addEventListener('change', function() {
        var hrElement = document.getElementById('colorChangeHr');
        if (this.checked) {
            hrElement.style.backgroundColor = '#06cf9c';   
        } else {
...
<script>
    document.getElementById('circularCheckbox2').addEventListener('change', function() {
        var hrElement = document.getElementById('colorChangeHr2');
        if (this.checked) {
            hrElement.style.backgroundColor = '#06cf9c'; 
        } else {
            hrElement.style.backgroundColor = 'black';  
...
$(document).on('click', '#bckimg', function () {
    ...
    var alignmentStyle = conversation.user_id == user_id ? 
        'text-align: 770px; margin-left: 770px;' : 
        'text-align: 770px; margin-right: 770px;';
    messageHtml = `
